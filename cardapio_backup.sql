...
\restrict dkhzfIKfevwC5Bz2m5xdR1CeT1SSJcXe9CbeDZmEQauJdKAhhOPAq2986jYolUD
...
--
-- Name: categories; Type: TABLE; Schema: public; Owner: cardapio_user
--
...
ALTER TABLE public.categories OWNER TO cardapio_user;

--
-- Name: drinks; Type: TABLE; Schema: public; Owner: cardapio_user
--
...
ALTER TABLE public.drinks OWNER TO cardapio_user;
...
--
-- Name: categories categories_pkey; Type: CONSTRAINT; Schema: public; Owner: cardapio_user
--
...
--
-- Name: categories categories_slug_key; Type: CONSTRAINT; Schema: public; Owner: cardapio_user
--
...
--
-- Name: drinks drinks_pkey; Type: CONSTRAINT; Schema: public; Owner: cardapio_user
--
...
--
-- Name: drinks drinks_categoria_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: cardapio_user
--

ALTER TABLE ONLY public.drinks
    ADD CONSTRAINT drinks_categoria_id_fkey FOREIGN KEY (categoria_id) REFERENCES public.categories(id);
...
\unrestrict dkhzfIKfevwC5Bz2m5xdR1CeT1SSJcXe9CbeDZmEQauJdKAhhOPAq2986jYolUD
